...
<style>
    ...
    .contractForm p input {
        border: 0;
        width: 20%;
        border-bottom: 1px solid #ced4da;
    }

    .contractForm li p input.min {
        width: 5%;
    }
...
<main>
    ...
    <div class="content-wrap">
        ...
        <div class="row">
            <div class="col-md-6">
                <h2 class="secHeading">Contract</h2>
            </div>
        </div>
            ...
            <form class="contractForm ">
                <div>
                    <p>Personal Training Contract This Personal Training Contract (“Contract”) is entered on <input
                            type="text" class="d-inline form-control" name="field1" disabled  value="{{ $contract->field1 ?? '' }}"> ( “<strong>Effective Date</strong>”),
                        by and between  Fitzen.Studio (Fitzen) , Coimbatore, Tamil Nadu, India and <input type="text" class="d-inline form-control" name="field2" disabled  value="{{ $contract->field2 ?? '' }}"> with an address of <input
                            type="text" class="d-inline form-control w-50" name="field3" disabled  value="{{ $contract->field3 ?? '' }}"> ,(“Client”), collectively the “Parties.”
                    </p>
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="">BY:</label>
                            <input type="text" class="form-control" name="company_name" value="Admin" disabled  value="{{ $contract->company_name ?? '' }}">
                        </div>
                        <div class="form-group">
                            <label for="">Date:</label>
                            <input type="date" class="form-control" name="company_date" value="{{ date('Y-m-d') }}" disabled  value="{{ date('d-m-Y', strtotime($contract->company_date)) ?? '' }}">
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <img src="{{ asset($contract->client_siganture) }}" alt="your image"  height= "115px" width= "120px" />
                        </div>
                      
                        <div class="form-group">
                            <label for="">By:</label>
                            <input type="text" class="form-control" name="client_name" required  value="{{ $contract->client_name }}">
                        </div>
                        <div class="form-group">
                            <label for="">Date:</label>
                            <input type="date" class="form-control" name="client_date" disabled value="{{ date('Y-m-d',strtotime($contract->client_date)) ?? '' }}">
                        </div>
