...
<head>
    <title>Status Symbol Dezign</title>
                                ...
                                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="">
                                    <tr>
                                        <td align="left" valign="top"
                                            ...
                                            class="mobile-center">
                                            <h1 style="text-align: center;font-size: 36px; font-weight: 800; margin: 0; color: #ffffff;">
                                                STATUS SYMBOL DEZIGN</h1>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                                    ...
                                    <td align="left" style="padding-top: 20px;">
                                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                            ...
                                            @foreach($order_detail as $item)
                                                ...
                                                @php 
                                                    $product_name = DB::table('products')->where('id',$item["product_id"])->first();
                                                    $color        = DB::table('order_options')->where('order_id',$order["id"])->first();
                                                @endphp
                                                <tr>
                                                    <td width="35%" align="left" style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px; padding: 15px 10px 5px 10px;">
                                                        <a href="{{URL::to('/').'/shop/'.$product_name->slug}}" target="_blank">{{$product_name->product_name}}</a>
                                                    </td>
                                                    <td width="30%" align="left" style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px; padding: 15px 10px 5px 10px;">
                                                       @if($color->color != null)
                                                            <p><strong>Color: </strong>{{ $color->color }}</p>
                                                       @endif
                                                       @if($color->size != null)
                                                            <p><strong>Size: &nbsp;</strong>{{ $color->size }}</p>
                                                       @endif
                                    ...
                                    <td align="left" style="padding-top: 20px;">
                                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                            <tr>
                                                ...
                                                <td width="25%" align="left"
                                                    style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 800; line-height: 24px; padding: 10px; border-top: 3px solid #eeeeee; border-bottom: 3px solid #eeeeee;">
                                                    ${{$order['total_amount']+$order['shipping_cost']}} </td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td align="center" style="border-radius: 5px;" bgcolor="#66b3b7"> <a
                                                        ...
                                                        style="font-size: 18px; font-family: Open Sans, Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; border-radius: 5px; background-color: #694367; padding: 15px 30px; display: block;">Shop
                                                        Again</a> </td>
                                            </tr>
                                        </table>
                                    </td>
                    ...
                    <tr>
                        <td align="center" style="padding: 35px; background-color: #ffffff;" bgcolor="#ffffff">
                            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%"
                                ...
                                <tr>
                                    <td align="center"> <img
                                            src="https://custom.designwebdemos.com/status-symbol-design/public/uploads/settings/1645612984.png"
                                            width="150" height="80" style="display: block; border: 0px;" /> </td>
                                </tr>
                                <tr>
                                    <td align="center"
