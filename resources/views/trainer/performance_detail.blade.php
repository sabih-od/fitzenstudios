                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $detail["customer"]->first_name.' '.$detail["customer"]->last_name }}"
    ...
    @else
        <main>
            <div class="content-wrap">
                <div class="row">
                    <div class="col">
                        <h4 style="text-align: center"><span class="alert alert-danger">Please Enter Customer Performance First..!!</span></h4>
                    </div>
                </div>
            </div>
        </main>
