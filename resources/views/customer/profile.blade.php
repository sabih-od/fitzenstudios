                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="dob" value="{{ $customer->dob ? date('Y-m-d' , strtotime($customer->dob)) : "" }}" class="form-control">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$customer->weight ?? ""}}" class="form-control" name="weight">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="">Nationality</label>
                                <input type="text" value="{{$customer->nationality ?? ""}}" class="form-control" name="nationality" >
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="">Country of Residence</label>
                                <input type="text" value="{{$customer->residence ?? ""}}" class="form-control" name="residence">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="None" value="{{ !empty($trainer) ? $trainer->name : '' }}" class="form-control" disabled>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
